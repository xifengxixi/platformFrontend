                                ...
                                <div style="border:1px solid rgb(234, 234, 234) ">
                                    <el-container>
                                        <editor v-contextmenu:contextmenu style="font-size: 15px"
                                            ...
                                            theme="chrome" width="100%" height="200px" :options="{}">
                                        </editor>
                                    </el-container>
                                </div>
                            </div>
                            <el-table :data="apiMsgData.variable" size="mini" stripe :show-header="false" height="200"
                                ...
                                <el-table-column label="Comparator" header-align="center" width="200">
                                    <template slot-scope="scope">
                                        <el-autocomplete class="inline-input" v-model="scope.row.comparator"
                                            :fetch-suggestions="querySearchComparator" placeholder="请选择"
...
export default {
    data() {
        return {
            ...
            comparators: [
                { 'value': 'equals' }, { 'value': 'contains' }, { 'value': 'contained_by' },
    ...
    methods: {
        ...
        getTestcaseNamesByIds(ids) {
            api.namesByIds({ids: ids})
            .then(response => {
        ...
        getTestcaseDetail() {
            ...
            .then(response => {
                ...
                this.getInterfaceNames(this.selected_project_id);
                ...
                this.getTestcaseNamesByIds(this.selected_testcase_id);
