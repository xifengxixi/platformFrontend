    ...
    <div class="ms-login">
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="ms-content">
        ...
        <el-form-item prop="email" :error="err_email_msg">
          <el-input v-model="ruleForm.email" placeholder="请输入邮箱" clearable @focus="clearValidate('email')">
            <el-button slot="prepend" icon="el-icon-lx-mail"></el-button>
          </el-input>
        </el-form-item>

        <el-form-item prop="password">
          <el-input type="password" placeholder="请输入密码" v-model="ruleForm.password" @focus="clearValidate('password')">
